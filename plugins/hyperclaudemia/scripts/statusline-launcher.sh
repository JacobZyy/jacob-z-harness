#!/bin/bash
# Launcher for hyperclaudemia statusline
# Auto-discovers the latest installed version from plugin cache.
# Pattern inspired by oh-my-claudecode's hud-wrapper approach.
set -e

CACHE_BASE="${CLAUDE_CONFIG_DIR:-$HOME/.claude}/plugins/cache/jacob-z-harness/hyperclaudemia"
WORKSPACE_PATH="/Users/jacobzha/Documents/workspace/jacob-open-source/jacob-z-harness/plugins/hyperclaudemia/scripts/statusline.sh"
...
echo "[hyperclaudemia] statusline not found"
